  ...
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        <Text style={styles.titulo}>CIRCUITO DE ILUMINAÇÃO LIGAÇÃO </Text>

        <Text style={styles.texto}>INTERRUPTOR DUAS SEÇÕES</Text>
        ...
        <Text style={styles.texto}>INTERRUPTOR TRÊS SEÇÕES</Text>
        <Image
          style={{
            height: 250,
            width: "100%",
